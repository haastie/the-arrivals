...
export const restaurantFields: Field[] = [
  ...
  { key: 'lat', label: 'Latitude (echt; leeg = afgeleid uit X/Y)', type: 'number' },
  { key: 'lng', label: 'Longitude (echt; leeg = afgeleid uit X/Y)', type: 'number' },
  { key: 'x', label: 'Kaart X (0-100; fallback zonder lat/lng)', type: 'number' },
  { key: 'y', label: 'Kaart Y (0-100; fallback zonder lat/lng)', type: 'number' },
...
export const settingsFields: Field[] = [
  ...
  { key: 'red_thread', label: 'Rode draad', type: 'textarea' },
  { key: 'central_question', label: 'Centrale vraag', type: 'textarea' },
  { key: 'mechanism', label: 'Mechanisme (de "zeef")', type: 'textarea' },
  { key: 'opening_line', label: 'Openingszin', type: 'textarea' },
  { key: 'land_acknowledgement', label: 'Land acknowledgement (Lenape)', type: 'textarea' },
